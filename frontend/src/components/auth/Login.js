                        ...
                        <div className="mt-12">
                            <form onSubmit={(e)=>(submiHandler(e))}>
                                ...
                                <div className="mt-8">
                                    ...
                                    <input className="w-full text-lg py-2 border-b border-gray-300 focus:outline-none focus:border-cl" type="password" required minLength='8' placeholder="Enter your password" value={pass} onChange={(e)=>(setPass(e.target.value))}/>
                                </div>
                                <div className="mt-10">
